      ...
      <div className="w-full min-h-[150px] flex items-center gap-x-4">
        ...
        <div className="w-full flex flex-col">
          ...
          <div className="flex gap-x-2 h-[36px] text-sm">
            ...
            <div className="flex items-center justify-around flex-1">$ {price}</div>
            <div className="flex justify-end items-center flex-1 text-primary font-medium">${parseFloat(price * amount).toFixed(2)}</div>
          </div>
        </div>
      </div>
    </div>
